...
final class DNSUpstreamBreakerTests: XCTestCase {
    ...
    func testAllowRequestWithExplicitNow() {
        ...
        XCTAssertTrue(breaker.allowRequest(now: now), "Breaker should allow requests with explicit now")
    }
    ...
    func testThresholdTriggersDegradation() {
        ...
        XCTAssertFalse(breaker.allowRequest(), "Breaker should block requests after reaching threshold")
    }
    ...
    func testCustomThreshold() {
        ...
        breaker.onFailure()
        XCTAssertFalse(breaker.allowRequest(), "Breaker should block after 5th failure (threshold 5)")
    }
