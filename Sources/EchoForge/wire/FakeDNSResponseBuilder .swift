...
public enum DNSMessageBuilder {
    ...
    public static func buildRefuseResponse(id: UInt16, rcode: DNSReturnStatus, originalQuestion: Data) -> Data {
        var writer = FBPacketBufferWriter()
        let flags: UInt16 =
            0x8000 // QR = 1 (response)
            | 0x0080 // RA = 1
    ...
    public static func buildServFailResponse(id: UInt16, originalQuestion: Data) -> Data {
        return buildRefuseResponse(id: id, rcode: .serverFailure, originalQuestion: originalQuestion)
    }
}
